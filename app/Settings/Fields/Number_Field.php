...
class Number_Field extends Field {
	...
	public static function admin_enqueue_scripts() {
		...
		# Enqueue JS
		wp_enqueue_script( 'carbon-field-number', $root_uri . 'public/js/bundle.js', array( 'carbon-fields-boot' ) );

		# Enqueue CSS
		wp_enqueue_style( 'carbon-field-number', $root_uri . 'public/css/field.css' );
	}
